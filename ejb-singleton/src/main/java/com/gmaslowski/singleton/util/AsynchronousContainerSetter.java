...
import com.gmaslowski.singleton.ContainerManagedConcurrencySomething;
...
@Stateless
@Asynchronous
public class AsynchronousContainerSetter {

    private static final Logger log = LoggerFactory.getLogger(AsynchronousContainerSetter.class);

    @EJB
    ContainerManagedConcurrencySomething concurrencySomething;
